...
from tests.dataset_generation.conftest import (
    install_bundled_spec as _install_bundled_spec,
)
from tests.dataset_generation.conftest import (
    install_fake_balanced_planner as _install_fake_balanced_planner,
)
from tests.dataset_generation.conftest import (
    install_fake_pool as _install_fake_pool,
)
from tests.dataset_generation.conftest import (
    make_balance_spec as _make_balance_spec,
)
from tests.dataset_generation.conftest import (
    make_fake_plan_sample as _make_fake_plan_sample,
)
from tests.dataset_generation.conftest import (
    make_simple_input_dir as _make_simple_input_dir,
)
from tests.dataset_generation.conftest import (
    make_tokenizer_dir as _make_tokenizer_dir,
)
from tests.dataset_generation.conftest import (
...
def _require_real_renderer_tests() -> None:
    if os.getenv("TRANSCODA_RUN_REAL_RENDERER_TESTS") != "1":
        pytest.skip("real Verovio renderer tests are opt-in")
