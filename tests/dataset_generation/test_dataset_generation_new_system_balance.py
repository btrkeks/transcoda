...
from scripts.dataset_generation.dataset_generation_new.calibrate_system_balance import (
    run_calibration,
)
...
from scripts.dataset_generation.dataset_generation_new.types import SamplePlan, SourceSegment
...
def test_choose_balanced_plan_prefers_candidate_closest_to_target_bucket(
    ...
    monkeypatch.setattr(
        "scripts.dataset_generation.dataset_generation_new.system_balance.plan_sample",
        fake_plan_sample,
    )
