...
def test_standard_pipeline_removes_tenuto_marks():
    transcription = """**kern
4c~
*-"""
...
def test_standard_pipeline_delays_spine_merge_to_barline():
...
"""
    ...
    expected = """*clefF4\t*clefF4\t*clefG2\t*clefG2
8D 8A\t8ryy\t8a)J\t.
*v\t*v\t*\t*
=\t=\t=""".strip()
...
def test_standard_pipeline_hoists_spine_split_to_barline():
