...
from .canonicalize_spine_splits import CanonicalizeSpineSplits
from .cap_slurs import CapSlurs
from .cleanup_kern import CleanupKern
from .delay_spine_merges_to_barline import DelaySpineMergesToBarline
from .fix_note_beams import FixNoteBeams
from .fix_slurs import FixSlurs
from .fix_ties import FixTies
from .hoist_spine_splits_to_barline import HoistSpineSplitsToBarline
...
PASS_REGISTRY: dict[str, type] = {
    ...
    "canonicalize_spine_splits": CanonicalizeSpineSplits,
    "cap_slurs": CapSlurs,
    "cleanup_kern": CleanupKern,
    "delay_spine_merges_to_barline": DelaySpineMergesToBarline,
    "fix_note_beams": FixNoteBeams,
    "fix_slurs": FixSlurs,
    "fix_ties": FixTies,
    "hoist_spine_splits_to_barline": HoistSpineSplitsToBarline,
