...
# Uses GNU parallel for speed and musicxml2hum from our humlib fork:
#   https://github.com/btrkeks/musicxml2hum
# Upstream musicxml2hum (craigsapp/humlib) may produce subtly different
# output and is not interchangeable for reproducing the published datasets.
