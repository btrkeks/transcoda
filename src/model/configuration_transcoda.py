...
class TranscodaConfig(PretrainedConfig):
    model_type = "transcoda"
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.architectures = ["TranscodaModelForCausalLM"]
        self.maxh = maxh
        self.maxw = maxw
        self.maxlen = maxlen
        ...
        if resolved_vocab_size != resolved_out_categories:
            raise ValueError("vocab_size and out_categories must match for TranscodaConfig")
