...
_EXPORTS = {
    ...
    "TranscodaWrapper": ("src.evaluation.wrappers", "TranscodaWrapper"),
    ...
    "compute_tedn_from_musicxml": ("src.evaluation.tedn", "compute_tedn_from_musicxml"),
    "TEDnScore": ("src.evaluation.tedn", "TEDnScore"),
