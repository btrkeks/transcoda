...
enabling fair comparison between the user's Transcoda model and PRAIG models.
"""
...
class TranscodaWrapper:
    """Wrapper for user's TranscodaModelForCausalLM.
